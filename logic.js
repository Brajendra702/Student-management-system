...
(function load(){
    ...
    for(x in students){
        ...
        write = write+`<tr><td>${students[x].ID}</td>
        <td>${students[x].name}</td><td>${students[x].email}</td>
        <td>${students[x].age}</td><td>${students[x].grade}</td>
        <td>${students[x].degree}
...
function searchStudents(){
    ...
    write = "";
    for(x in filter){
        write = write+`<tr><td>${filter[x].ID}</td>
        <td>${filter[x].name}</td><td>${filter[x].email}</td>
        <td>${filter[x].age}</td><td>${filter[x].grade}</td>
        <td>${filter[x].degree}
